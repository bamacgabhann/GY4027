![Topic 2 Cover image](./assets/images/landscape_evolution_banner_Erosion_Transport.png)

# Topic 2: Erosion and Transport

The landscape is shaped by moving material around. This topic, we consider the four agents of erosion and transport: gravity, water, ice, and air.
...
Lecture slides: [GY4027 L2 Erosion and Transport](./assets/lectures/L2_Erosion_and_Transport.pdf)
...
I suggest reading Chapter Three of Huggett, R. (2017) Fundamentals of Geomorphology, 4th Edition. Routledge, London.
...
There's little that will help to understand processes we take for granted more than changing some of the fundamentals of those processes. So, I suggest reading this paper on aeolian sediment transport on Mars. Different atmospheric pressure, different gravity. Some of it is a bit complex, but I think it will really help you to understand the processes of aeolian sediment transport on Earth.
